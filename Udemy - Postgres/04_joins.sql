...
insert into photos (url, user_id) values ('https://banner.jpg', null)
...
-- right join
insert into users (username) values ('Nickole')
...
from photos as p join comments as c on (c.photo_id = p.id)
