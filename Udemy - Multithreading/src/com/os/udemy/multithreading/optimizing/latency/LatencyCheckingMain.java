package com.os.udemy.multithreading.optimizing.latency;
...
public class LatencyCheckingMain {
    
    public static final String SOURCE_FILE = "many-flowers.jpg";
    public static final String DESTINATION_FILE = "many-flowers-updt.jpg";
