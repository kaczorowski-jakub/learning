...
/**
 * Run MatricesGenerator class to generate the input file for this program
 * 
...
public class MainApplicationV1 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        MatricesReaderProducer matricesReader = new MatricesReaderProducer(new FileReader(inputFile), queue);
        ...
        public void run() {
            while (true) {
                ...
                if (matrix1 == null || matrix2 == null) {
                    queue.terminate();
                    System.out.println("No more matricies to read. Producer Thread is terminating");
                    return;
                }
